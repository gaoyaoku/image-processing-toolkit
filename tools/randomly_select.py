...
def main(sar_path, optics_path, label_path, destination_sar_path, destination_optics_path, destination_label_path):
    source_folders = [
        optics_path,  # 第一个源文件夹路径
        sar_path,  # 第二个源文件夹路径
        label_path  # 第三个源文件夹路径
    ]

    destination_folders = [
        destination_optics_path,  # 第一个目标文件夹路径
        destination_sar_path,  # 第二个目标文件夹路径
        destination_label_path   # 第三个目标文件夹路径
    ]
